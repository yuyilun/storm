package com.hadoop.storm.trident;

import java.util.Random;

import com.hadoop.storm.trident.functions.MySplit;
import com.hadoop.storm.trident.functions.Split;
...
public class TridentPVTopo {
	...
	public static StormTopology buildTopology(LocalDRPC drpc) {
		...
		String[] time = { "2014-01-09 08:40:50", "2014-01-08 08:40:51", "2014-01-08 08:40:52", "2014-01-07 08:40:53",
				"2014-01-09 09:40:49", "2014-01-08 10:40:49", "2014-01-07 11:40:49", "2014-01-07 12:40:49" };
		...
		TridentState wordCounts = topology.newStream("spout1", spout)
				...
				.persistentAggregate(new MemoryMapState.Factory(), new Fields("session_id"),
						new Count(), new Fields("PV"));
		// .parallelismHint(16);
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length == 0) {
			...
			for (int i = 0; i < 100; i++) {
				System.err.println("DRPC RESULT: " + drpc.execute("GetPV", "2014-01-07  2014-01-09 2014-01-10"));
				Thread.sleep(1000);
			}
		} else {
